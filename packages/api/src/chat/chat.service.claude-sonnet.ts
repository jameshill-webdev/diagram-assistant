...
export function processChat(
  ...
  if (diagramType === "sequence") {
    return {
      ...
      message: "Here is your sequence diagram from Claude Sonnet.",
    };
  }
  if (diagramType === "branching") {
    return {
      diagram: BRANCHING_FLOWCHART,
      message: "Here is your branching flowchart from Claude Sonnet.",
    };
  }
  if (diagramType === "simple") {
    return {
      diagram: SIMPLE_FLOWCHART,
      message: "Here is your simple flowchart from Claude Sonnet.",
    };
  }
  return {
    diagram: "",
